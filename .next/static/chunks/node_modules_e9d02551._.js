...
*/ function replaceStep(doc, from) {
    let to = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : from, slice = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Slice"].empty;
...
*/ class Transform {
    ...
    */ addStep(step, doc) {
    ...
    given `slice`.
    */ replace(from) {
        let to = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : from, slice = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Slice"].empty;
...
*/ class Selection {
    ...
    */ replace(tr) {
        let content = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Slice"].empty;
...
function resetScrollPos(param) {
    let { refDOM, refTop, stack } = param;
...
class NodeViewDesc extends ViewDesc {
    ...
    protectLocalComposition(view, param) {
        let { node, pos, text } = param;
...
*/ function endComposition(view) {
    let restarting = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
...
var CommandManager = class {
    ...
    get commands() {
        ...
        return Object.fromEntries(Object.entries(rawCommands).map((param)=>{
            let [name, command2] = param;
            var _this = this;
    ...
    createChain(startTr) {
        let shouldDispatch = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
        const { rawCommands, editor, state } = this;
        const { view } = editor;
        const callbacks = [];
        ...
        const chain = {
            ...Object.fromEntries(Object.entries(rawCommands).map((param)=>{
                let [name, command2] = param;
                var _this = this;
                const chainedCommand = function() {
                    ...
                    const props = _this.buildProps(tr, shouldDispatch);
                    const callback = command2(...args)(props);
    ...
    createCan(startTr) {
        ...
        const formattedCommands = Object.fromEntries(Object.entries(rawCommands).map((param)=>{
            let [name, command2] = param;
            return [
                name,
                function() {
...
function createDocument(content, schema) {
    let parseOptions = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, options = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {};
...
function callOrReturn(value) {
    let context = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : void 0;
    ...
    extensions.forEach((extension)=>{
        ...
        globalAttributes.forEach((globalAttribute)=>{
            globalAttribute.types.forEach((type)=>{
                Object.entries(globalAttribute.attributes).forEach((param)=>{
                    let [name, attribute] = param;
    ...
    return objects.filter((item)=>!!item).reduce((items, item)=>{
        ...
        Object.entries(item).forEach((param)=>{
            ...
            if (key === "class") {
                ...
                mergedAttributes[key] = Array.from(styleMap.entries()).map((param)=>{
                    let [property, val] = param;
...
function cleanUpSchemaItem(data) {
    ...
    Object.entries(data).filter((param)=>{
        let [key, value] = param;
...
function getTextSerializersFromSchema(schema) {
    return Object.fromEntries(Object.entries(schema.nodes).filter((param)=>{
        let [, node] = param;
...
function removeDuplicates(array) {
    let by = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : JSON.stringify;
    const seen = {};
...
function getDebugJSON(node) {
    let startOffset = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
...
var getNodeAtPosition = function(state, typeOrName, pos) {
    let maxDepth = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 20;
...
function getSplittedAttributes(extensionAttributes, typeName, attributes) {
    return Object.fromEntries(Object.entries(attributes).filter((param)=>{
        let [name] = param;
...
var getTextContentFromNodes = function($from) {
    let maxMatch = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 500;
    let textBefore = "";
...
function isNodeEmpty(node) {
    let { checkChildren = true, ignoreWhitespace = false } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    var _a;
    if (ignoreWhitespace) {
...
function minMax() {
    let value = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, min = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, max = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0;
...
function resolveFocusPosition(doc) {
    let position = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
    if (!position) {
        return null;
    }
...
function rewriteUnknownContentInner(param) {
    let { json, validMarks, validNodes, options, rewrittenContent = [] } = param;
...
var Extendable = class {
    ...
    extend() {
        let extendedConfig = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
...
var Mark = class _Mark extends Extendable {
   ...
   */ static create() {
    ...
    static handleExit(param) {
        let { editor, mark } = param;
...
function pasteRulesPlugin(props) {
    ...
    const processEvent = (param)=>{
        let { state, from, to, rule, pasteEvt } = param;
        const tr = state.tr;
   ...
   */ get plugins() {
        ...
        const allPlugins = extensions.map((extension)=>{
            ...
            if (addKeyboardShortcuts) {
                const bindings = Object.fromEntries(Object.entries(addKeyboardShortcuts()).map((param)=>{
                    let [shortcut, method] = param;
                    return [
                        shortcut,
                        ()=>method({
                                editor
...
var clearContent = function() {
    let emitUpdate = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
    return (param)=>{
        let { commands } = param;
...
;
var clearNodes = ()=>(param)=>{
        let { state, tr, dispatch } = param;
        const { selection } = tr;
        const { ranges } = selection;
        if (!dispatch) {
            return true;
...
;
var cut = (originRange, targetPos)=>(param)=>{
        let { editor, tr } = param;
        const { state } = editor;
...
var deleteNode = (typeOrName)=>(param)=>{
...
var focus = function() {
    let position = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null, options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    return (param)=>{
        let { editor, view, tr, dispatch } = param;
        options = {
            scrollIntoView: true,
            ...options
        };
...
var insertContent = (value, options)=>(param)=>{
        let { tr, commands } = param;
...
var insertContentAt = (position, value, options)=>(param)=>{
        let { tr, dispatch, editor } = param;
        var _a;
        if (dispatch) {
            options = {
...
;
var joinItemBackward = ()=>(param)=>{
        let { state, dispatch, tr } = param;
        try {
...
;
var joinTextblockBackward = ()=>(param)=>{
        let { state, dispatch } = param;
...
;
var joinTextblockForward = ()=>(param)=>{
        let { state, dispatch } = param;
...
var keyboardShortcut = (name)=>(param)=>{
        let { editor, view, tr, dispatch } = param;
...
;
var liftListItem = (typeOrName)=>(param)=>{
        let { state, dispatch } = param;
        const type = getNodeType(typeOrName, state.schema);
...
var resetAttributes = (typeOrName, attributes)=>(param)=>{
        let { tr, state, dispatch } = param;
        let nodeType = null;
        let markType = null;
        const schemaType = getSchemaTypeNameByName(typeof typeOrName === "string" ? typeOrName : typeOrName.name, state.schema);
...
;
var selectTextblockStart = ()=>(param)=>{
        let { state, dispatch } = param;
...
var setContent = function(content) {
    let { errorOnInvalidContent, emitUpdate = true, parseOptions = {} } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    return (param)=>{
        let { editor, tr, dispatch, commands } = param;
        const { doc } = tr;
...
var setNode = function(typeOrName) {
    let attributes = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    return (param)=>{
        let { state, dispatch, chain } = param;
        const type = getNodeType(typeOrName, state.schema);
...
;
var setNodeSelection = (position)=>(param)=>{
        let { tr, dispatch } = param;
        if (dispatch) {
            const { doc } = tr;
...
;
var setTextSelection = (position)=>(param)=>{
        let { tr, dispatch } = param;
        if (dispatch) {
            const { doc } = tr;
...
;
var sinkListItem = (typeOrName)=>(param)=>{
        let { state, dispatch } = param;
        const type = getNodeType(typeOrName, state.schema);
...
var splitBlock = function() {
    let { keepMarks = true } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    return (param)=>{
        let { tr, state, dispatch, editor } = param;
...
var splitListItem = function(typeOrName) {
    let overrideAttrs = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    return (param)=>{
        let { tr, state, dispatch, editor } = param;
        var _a;
        const type = getNodeType(typeOrName, state.schema);
...
var toggleList = function(listTypeOrName, itemTypeOrName, keepMarks) {
    let attributes = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {};
    return (param)=>{
        let { editor, tr, state, dispatch, chain, commands, can } = param;
...
var toggleMark = function(typeOrName) {
    let attributes = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    return (param)=>{
        let { state, commands } = param;
...
var Delete = Extension.create({
    name: "delete",
    onUpdate (param) {
        let { transaction, appendedTransactions } = param;
        var _a, _b, _c;
        const callback = ()=>{
            var _a2, _b2, _c2, _d;
...
var Keymap = Extension.create({
    ...
    addKeyboardShortcuts () {
        const handleBackspace = ()=>this.editor.commands.first((param)=>{
                let { commands } = param;
                return [
        ...
        const handleDelete = ()=>this.editor.commands.first((param)=>{
                let { commands } = param;
                return [
                    ()=>commands.deleteSelection(),
        ...
        const handleEnter = ()=>this.editor.commands.first((param)=>{
                let { commands } = param;
                return [
...
var NodePos = class _NodePos {
    ...
    querySelectorAll(selector) {
        let attributes = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, firstItemOnly = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
        let nodes = [];
...
var Editor = class extends EventEmitter {
   ...
   */ setEditable(editable) {
        let emitUpdate = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
        this.setOptions({
            editable
        });
        if (emitUpdate) {
   ...
   */ get view() {
        ...
        return new Proxy({
            ...
            get: (obj, key)=>{
                ...
                throw new Error("[tiptap error]: The editor view is not available. Cannot access view['".concat(key, "']. The editor may not be mounted yet."));
            }
        });
    }
    /**
   ...
   */ get isDestroyed() {
     ...
     */ this.instanceId = Math.random().toString(36).slice(2, 9);
        ...
        this.on("drop", (param)=>{
            let { event, slice, moved } = param;
            return this.options.onDrop(event, slice, moved);
        });
        this.on("paste", (param)=>{
            let { event, slice } = param;
            return this.options.onPaste(event, slice);
        });
...
function wrappingInputRule(config) {
    return new InputRule({
        find: config.find,
        handler: (param)=>{
            let { state, range, match, chain } = param;
            const attributes = callOrReturn(config.getAttributes, void 0, match) || {};
...
// src/MarkView.ts
function updateMarkViewAttributes(checkMark, editor) {
...
var NodeView = class {
    ...
    onDragStart(event) {
        ...
        try {
            const domBox = this.dom.getBoundingClientRect();
            clonedNode.style.width = "".concat(Math.round(domBox.width), "px");
            clonedNode.style.height = "".concat(Math.round(domBox.height), "px");
   ...
   */ updateAttributes(attributes) {
        this.editor.commands.command((param)=>{
            let { tr } = param;
            const pos = this.getPos();
            if (typeof pos !== "number") {
                return false;
...
function markPasteRule(config) {
    return new PasteRule({
        find: config.find,
        handler: (param)=>{
            let { state, range, match, pasteEvent } = param;
...
function nodePasteRule(config) {
    return new PasteRule({
        find: config.find,
        handler (param) {
            let { match, chain, range, pasteEvent } = param;
            const attributes = callOrReturn(config.getAttributes, void 0, match, pasteEvent);
...
"[project]/node_modules/fast-deep-equal/es6/react.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@tiptap/react/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "CommandManager",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CommandManager"],
    "Editor",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Editor"],
    "EditorConsumer",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["EditorConsumer"],
    "EditorContent",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["EditorContent"],
    "EditorContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["EditorContext"],
    "EditorProvider",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["EditorProvider"],
    "Extension",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Extension"],
    "Fragment",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"],
    "InputRule",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InputRule"],
    "Mark",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mark"],
    "MarkView",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MarkView"],
    "MarkViewContent",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["MarkViewContent"],
    "Node",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Node"],
    "NodePos",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodePos"],
    "NodeView",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NodeView"],
    "NodeViewContent",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["NodeViewContent"],
    "NodeViewWrapper",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["NodeViewWrapper"],
    "PasteRule",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PasteRule"],
    "PureEditorContent",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["PureEditorContent"],
    "ReactMarkView",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactMarkView"],
    "ReactMarkViewContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactMarkViewContext"],
    "ReactMarkViewRenderer",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactMarkViewRenderer"],
    "ReactNodeView",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactNodeView"],
    "ReactNodeViewContentProvider",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactNodeViewContentProvider"],
    "ReactNodeViewContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactNodeViewContext"],
    "ReactNodeViewRenderer",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactNodeViewRenderer"],
    "ReactRenderer",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ReactRenderer"],
    "Tracker",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tracker"],
    "callOrReturn",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["callOrReturn"],
    "canInsertNode",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["canInsertNode"],
    "combineTransactionSteps",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["combineTransactionSteps"],
    "createChainableState",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createChainableState"],
    "createDocument",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDocument"],
    "createElement",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"],
    "createNodeFromContent",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createNodeFromContent"],
    "createStyleTag",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createStyleTag"],
    "defaultBlockAt",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defaultBlockAt"],
    "deleteProps",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteProps"],
    "elementFromString",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["elementFromString"],
    "escapeForRegEx",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["escapeForRegEx"],
    "extensions",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extensions"],
    "findChildren",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findChildren"],
    "findChildrenInRange",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findChildrenInRange"],
    "findDuplicates",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findDuplicates"],
    "findParentNode",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findParentNode"],
    "findParentNodeClosestToPos",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findParentNodeClosestToPos"],
    "flattenExtensions",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["flattenExtensions"],
    "fromString",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromString"],
    "generateHTML",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateHTML"],
    "generateJSON",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateJSON"],
    "generateText",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateText"],
    "getAttributes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAttributes"],
    "getAttributesFromExtensions",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAttributesFromExtensions"],
    "getChangedRanges",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getChangedRanges"],
    "getDebugJSON",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDebugJSON"],
    "getExtensionField",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getExtensionField"],
    "getHTMLFromFragment",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getHTMLFromFragment"],
    "getMarkAttributes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMarkAttributes"],
    "getMarkRange",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMarkRange"],
    "getMarkType",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMarkType"],
    "getMarksBetween",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMarksBetween"],
    "getNodeAtPosition",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNodeAtPosition"],
    "getNodeAttributes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNodeAttributes"],
    "getNodeType",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNodeType"],
    "getRenderedAttributes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRenderedAttributes"],
    "getSchema",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSchema"],
    "getSchemaByResolvedExtensions",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSchemaByResolvedExtensions"],
    "getSchemaTypeByName",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSchemaTypeByName"],
    "getSchemaTypeNameByName",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSchemaTypeNameByName"],
    "getSplittedAttributes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSplittedAttributes"],
    "getText",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getText"],
    "getTextBetween",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTextBetween"],
    "getTextContentFromNodes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTextContentFromNodes"],
    "getTextSerializersFromSchema",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTextSerializersFromSchema"],
    "h",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["h"],
    "injectExtensionAttributesToParseRule",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["injectExtensionAttributesToParseRule"],
    "inputRulesPlugin",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["inputRulesPlugin"],
    "isActive",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isActive"],
    "isAndroid",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAndroid"],
    "isAtEndOfNode",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAtEndOfNode"],
    "isAtStartOfNode",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAtStartOfNode"],
    "isEmptyObject",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isEmptyObject"],
    "isExtensionRulesEnabled",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isExtensionRulesEnabled"],
    "isFunction",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFunction"],
    "isList",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isList"],
    "isMacOS",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isMacOS"],
    "isMarkActive",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isMarkActive"],
    "isNodeActive",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNodeActive"],
    "isNodeEmpty",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNodeEmpty"],
    "isNodeSelection",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNodeSelection"],
    "isNumber",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNumber"],
    "isPlainObject",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isPlainObject"],
    "isRegExp",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRegExp"],
    "isString",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isString"],
    "isTextSelection",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isTextSelection"],
    "isiOS",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isiOS"],
    "markInputRule",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["markInputRule"],
    "markPasteRule",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["markPasteRule"],
    "mergeAttributes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeAttributes"],
    "mergeDeep",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mergeDeep"],
    "minMax",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["minMax"],
    "nodeInputRule",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["nodeInputRule"],
    "nodePasteRule",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["nodePasteRule"],
    "objectIncludes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["objectIncludes"],
    "pasteRulesPlugin",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pasteRulesPlugin"],
    "posToDOMRect",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["posToDOMRect"],
    "removeDuplicates",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeDuplicates"],
    "resolveExtensions",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveExtensions"],
    "resolveFocusPosition",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveFocusPosition"],
    "rewriteUnknownContent",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rewriteUnknownContent"],
    "selectionToInsertionEnd",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["selectionToInsertionEnd"],
    "sortExtensions",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sortExtensions"],
    "splitExtensions",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["splitExtensions"],
    "textInputRule",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["textInputRule"],
    "textPasteRule",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["textPasteRule"],
    "textblockTypeInputRule",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["textblockTypeInputRule"],
    "updateMarkViewAttributes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateMarkViewAttributes"],
    "useCurrentEditor",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useCurrentEditor"],
    "useEditor",
    ...
    "useReactNodeView",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useReactNodeView"],
    "wrappingInputRule",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$core$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["wrappingInputRule"]
]);
...
"[project]/node_modules/@tiptap/react/dist/index.js [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/node_modules/@tiptap/react/dist/index.js [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=node_modules_e9d02551._.js.map